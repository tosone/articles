...
<!-- tags: Supply Chain Security, npm, RAT, Incident Analysis -->
...
<!-- table-svg: attack-summary-table.svg -->
| 维度     | 这次攻击怎么做                                                                         | 工程含义                                                                     |
| -------- | -------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
...
<!-- table-svg: attack-malicious-packages-table.svg -->
| 包名                      | 角色                                      |
| ------------------------- | ----------------------------------------- |
...
<!-- table-svg: attack-platform-behavior-table.svg -->
| 平台    | 公开报道中的行为                                                              | 防守关注点                                                        |
| ------- | ----------------------------------------------------------------------------- | ----------------------------------------------------------------- |
...
<!-- table-svg: attack-patterns-table.svg -->
| 类型                                | 传统风险                           | 这次体现                                                  |
| ----------------------------------- | ---------------------------------- | --------------------------------------------------------- |
...
<!-- table-svg: attack-ioc-table.svg -->
| 类型                  | 指标                                                                                                |
| --------------------- | --------------------------------------------------------------------------------------------------- |
| GitHub 账号           | `smi1e2u`                                                                                           |
...
<!-- table-svg: attack-payload-hashes-table.svg -->
| SHA-256                                                            | 含义                                                 |
| ------------------------------------------------------------------ | ---------------------------------------------------- |
...
<!-- table-svg: attack-response-checklist-table.svg -->
| 检查项        | 具体动作                                                                           |
| ------------- | ---------------------------------------------------------------------------------- |
